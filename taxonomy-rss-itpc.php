    ...
    <?php while ( have_posts() ) : the_post(); ?>
      ...
      <?php if ( has_post_thumbnail() ) {
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week21_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week21_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week21_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week20_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week20_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week20_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week19_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week19_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week19_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week18_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week18_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week18_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week17_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week17_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week17_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week16_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week16_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week16_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week15_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week15_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week15_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week14_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week14_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week14_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week13_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week13_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week13_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week12_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week12_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week12_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week11_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week11_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week11_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week10_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week10_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week10_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week9_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week9_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week9_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week8_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week8_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week8_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week7_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week7_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week7_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week6_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week6_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week6_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week5_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week5_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week5_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week4_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week4_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week4_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week3_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week3_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week3_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week2_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week2_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week2_passage', true ) ?></itunes:subtitle>
            ...
            <item>
              ...
              ?>
              <title><?php the_title(); ?> - <?php get_post_meta( $post->ID, 'week1_title', true ) ?></title>

              <itunes:author><?php get_post_meta( $post->ID, 'week1_speaker', true ) ?></itunes:author>

              <itunes:subtitle>Scripture: <?php get_post_meta( $post->ID, 'week1_passage', true ) ?></itunes:subtitle>
